...
}) => <TabsPrimitive.List className={cn('inline-flex bg-background min-h-10 w-full flex-nowrap items-center justify-start gap-2', className)} {...props} />;
...
}) => <TabsPrimitive.Trigger className={cn(tabVariants({ variant, size, className }))} {...props} />;
